...
function Table({dataRaw, update, extstate, extmodel, reset, drawerOpen, clear, handleApi}) {
    ...
    const table = useTable({
        ...
        onSortingChange: (updater) => changeState('sorting', updater, 'setSorting'),
        onColumnFiltersChange: (updater) => changeState('columnFilters', updater, 'setColumnFilters'),
        onColumnSizingChange: (updater) => changeState('columnSizing', updater, 'setColumnSizing'),
