...
export const minerColumns = [
    ...
    {accessorKey: 'perpetualtune', header: 'Perpetual Tune', size: 150},
    {accessorKey: 'perpetualtunealgo', header: 'Perpetual Tune Algorithm', size: 225},
    {accessorKey: 'perpetualtuneoptimized', header: 'Perpetual Tune Optimized', size: 225},
    {
    ...
    {accessorKey: 'perpetualtuneminthrottle', header: 'Perpetual Tune Min Throttle', size: 225},
    {accessorKey: 'perpetualtunethrottlestep', header: 'Perpetual Tune Throttle Step', size: 225},
